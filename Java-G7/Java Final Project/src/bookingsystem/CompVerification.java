...
public class CompVerification extends javax.swing.JFrame {
//void showDate() {
//        Date d = new Date();
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Please enter your Company's Liscene no.:");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if (jTextField1.getText().equals("Airline123")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompVerification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompVerification().setVisible(true);
            }
        });
    }
