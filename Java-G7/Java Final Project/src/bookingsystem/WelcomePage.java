...
public class WelcomePage extends javax.swing.JFrame {
    ...
    public WelcomePage() {
        ...
        try {
            for (int i = 0; i <= 100; i++) {
                ...
                if (i == 100) {
                    jLabel13.setText("Setting Up...");
                    this.dispose();
                    LandingPage lp = new LandingPage();
                    lp.setVisible(true);
                }
                if (i == 70) {
                    jLabel13.setText("On progress...");

                }
                if (i == 50) {
                    jLabel13.setText("Preparing...");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bookingsystem/Logo.png"))); // NOI18N
